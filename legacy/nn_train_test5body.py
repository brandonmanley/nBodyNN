...
df_X_train = pd.read_csv(dataPath+"X_train_5body.csv")
df_X_test = pd.read_csv(dataPath+"X_test_5body.csv")
df_y_train = pd.read_csv(dataPath+"y_train_5body.csv")
...
network.save_weights(workDir + 'work/nbody/weights5/final_5body.h5')
...
import csv
with open(dataPath+'results_final_5body.csv', 'w', newline='') as file:
