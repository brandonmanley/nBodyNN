...
#define DELTAT 0.00390625       // Time increament
...
typedef struct Cell  {
   int index;                    // Index into arrays to identify particle's position and mass
...
int pindex;          // The pindex points to the slot in the vectors/arrays that contains data concerning the current processor, i.e pindex = (rank * part_size)
